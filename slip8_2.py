...
# Define groceries dataset directly
data = {
...
frequent_itemsets.to_csv('groceries_frequent_itemsets.csv', index=False)
rules.to_csv('groceries_association_rules.csv', index=False)

print("\nResults saved to 'groceries_frequent_itemsets.csv' and 'groceries_association_rules.csv'")
